...
////// Emissive:
                ...
                float3 emissive = (smoothstep( (node_9892+_HoleEdgeSmoothness), (node_9892-_HoleEdgeSmoothness), (1.0 - pow(1.0-max(0,dot(normalDirection, viewDirection)),0.15)) )*tex2D( Refraction, ((pow((1.0 - pow(1.0-max(0,dot(normalDirection, viewDirection)),_DistortionStrength)),6.0)*(sceneUVs.rg*-2.0+1.0))+sceneUVs.rg)).rgb);
